...
<div class="section" id="unsplash-settings" data-save="<?=$_['saveSettingsUrl']?>">
    ...
    <form>
        ...
        <div>
            <label for="headerbackgroundlink"><?php p($l->t('Set a custom Unsplash-URL')); ?></label>
            <br>
            <input id="headerbackgroundlink" type="text" placeholder="<?php p($l->t('headerbackgroundlink')); ?>" value="<?php if(isset($_['headerbackgroundlink']))p($_['headerbackgroundlink']); ?>" maxlength="250" />
        </div>
    </form>
</div>